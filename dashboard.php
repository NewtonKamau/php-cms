		...
		<div class="row">
			<div class="col-sm-2">
				...
				<ul id="side_menu" class="nav nav-pills nav-stacked">
					<li class="active"><a href="/Dashboard.php"><span class="glyficons glyficon-th"></span> &nbsp; Dashboard</a></li>
					<li><a href="/#"><span class="glyficons glyficon-list-alt"></span>&nbsp; Add New Post</a></li>
					<li><a href="/categories.php"><span class="glyficons glyficon-tags"></span>&nbsp; Categories</a></li>
